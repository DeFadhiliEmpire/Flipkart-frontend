            ...
            <div className="mb-4">
              ...
              <ul className="ml-2">
                <li className="text-gray-700 px-2 py-1 mb-1 cursor-pointer hover:bg-gray-100 rounded flex items-center justify-between">
                  Gift Cards{" "}
                  <span className="text-green-600 font-semibold">KSH0</span>
                </li>
                <li className="text-gray-700 px-2 py-1 mb-1 cursor-pointer hover:bg-gray-100 rounded">
                  Saved UPI
                </li>
        ...
        <div className="flex-1 bg-white rounded shadow p-8">
          ...
          <div className="mb-4">
            ...
            <label className="mr-6">
              <input type="radio" className="mr-1" /> Male
            </label>
            <label>
              <input type="radio" className="mr-1" /> Female
            </label>
          </div>
          ...
          <button
            onClick={() => {
              UpdateProfile(); // Call your profile update function
              setIsEditing(false); // Lock the fields again
            }}
            className="bg-blue-400 px-2 py-2 hover:bg-blue-200 rounded"
          >
            Update profile
          </button>
